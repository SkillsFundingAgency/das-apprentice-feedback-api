...
namespace SFA.DAS.ApprenticeFeedback.Application.UnitTests.Commands.ProcessEmailTransactionCommandTests
{
    ...
    {
        [Test, AutoMoqData]
        public async Task AndTransactionTemplateUnknown_AndEmailTemplateNotFound_ThenEmailResultSuccessful(
        ...
        [Test, AutoMoqData]
        public async Task AndTransactionTemplateUnknown_AndEmailTemplateNotFound_ThenRemoveFeedbackTransaction(
           [Frozen] Mock<IFeedbackTransactionContext> feedbackTransactionContext,
           [Frozen] Mock<IExclusionContext> exclusionContext,
           [Frozen] Mock<IEngagementEmailContext> engagementEmailContext,
           [Frozen] Mock<IEmailTemplateService> emailTemplateService,
        ...
        [Test, AutoMoqData]
        public async Task AndTransactionTemplateUnknown_AndEmailTemplateNotFound_ThenNoEmailSent(
           [Frozen] Mock<IFeedbackTransactionContext> feedbackTransactionContext,
           [Frozen] Mock<IExclusionContext> exclusionContext,
           [Frozen] Mock<IEngagementEmailContext> engagementEmailContext,
           [Frozen] Mock<IEmailTemplateService> emailTemplateService,
