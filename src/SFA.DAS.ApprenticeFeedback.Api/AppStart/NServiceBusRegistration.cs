        ...
        private static DbConnection CreateSqlConnection(IConfiguration configuration, ApplicationSettings appSettings)
        {
            ...
            else
            {
                return new SqlConnection
                {
                    ...
                    AccessToken = new DefaultAzureCredential().GetTokenAsync(new TokenRequestContext(new string[] { "https://citizenazuresfabisgov.onmicrosoft.com/das-at-appfbapi-as-ar/.default" })).Result.Token
            };
            }
        }
    }
